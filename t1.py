...
#
#
# df = pd.read_csv('load_data_with weather.csv')
# list = ['COAST', 'ERCOT', 'Temperature', 'Dewpoint', 'RH', 'Windspeed']
# for i in list:
#     df[i].interpolate(method='linear', axis=0, inplace=True)

# df.to_csv('load_data_with weather without nan.csv', sep=',', index=False, header=True)
#
